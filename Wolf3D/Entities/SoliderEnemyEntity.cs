...
{
    public enum SoldierSpriteState
    {
        Idle,
        Walk,
        Shoot,
    ...
    public class SoliderEnemyEntity : ShootableEntity
    {
        ...
        public SoliderEnemyEntity(PlayerState playerState, List<Sprite> Sprites, int[,] map, List<Sprite> gibSprites, List<SoundEffect> hitEffects) : base("solider-enemy")
        {
            ...
            sprite.AddAnimation(SoldierSpriteState.Idle.ToString(), new SpriteAnimation(new Sprite[] { Sprites[0] }, 12));
