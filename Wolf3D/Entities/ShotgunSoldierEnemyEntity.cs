...
{
    public class ShotgunSoldierEnemyEntity : ShootableEntity
    {
        public AnimatedWolfSprite sprite;
        BoxCollider collider;
        PlayerState playerState;
        List<Sprite> gibSprites;
        ShotgunSoldierController controller;
        SoundEffect[] hitEffects;

        bool dead;
        float gibChance = 0.2f;

        public ShotgunSoldierEnemyEntity(PlayerState playerState, List<Sprite> Sprites, int[,] map, List<Sprite> gibSprites, List<SoundEffect> hitEffects) : base("solider-enemy")
        {
            ...
            sprite.AddAnimation(SoldierSpriteState.Idle.ToString(), new SpriteAnimation(new Sprite[] { Sprites[0] }, 1));
            ...
            controller = new ShotgunSoldierController();
