...
namespace Wolf3D.Weapons
{
    public class GrenadeLauncher : IWeapon
    {
        ...
        public GrenadeLauncher(SpriteAnimator sprite, PlayerState state, TextComponent ammoText, SoundEffect shotSound)
        {
            handsSprite = sprite;
            playerState = state;
        ...
        public void Shoot()
        {
            ...
            var proj = new Projectile(playerState.Entity.Scene, ParticleType.Grenade, dir, physicsLayer, collidesWith, playerState, 10, 80f);
